...
using TplDemo.IServices.BASE;
using TplDemo.Repository.BASE;

namespace TplDemo.Services.BASE
{
    public class BaseServices<TEntity> : IBaseServices<TEntity> where TEntity : class, new()
    {
        ...
        /// <summary>功能描述:根据ID查询一条数据 作　　者:AZLinli.Blog.Core</summary>
        ...
        /// <summary>功能描述:根据ID查询数据 作　　者:AZLinli.Blog.Core</summary>
        ...
        /// <summary>功能描述:查询所有数据 作　　者:AZLinli.Blog.Core</summary>
        ...
        /// <summary>功能描述:查询数据列表 作　　者:AZLinli.Blog.Core</summary>
        ...
        {
            return await BaseDal.Query(whereExpression, selectExpression, strOrderByFileds);
        }

        /// <summary>功能描述:查询一个列表 作　　者:AZLinli.Blog.Core</summary>
        ...
        /// <summary>功能描述:查询前N条数据 作　　者:AZLinli.Blog.Core</summary>
        /// <param name="whereExpression">条件表达式</param>
        ...
        /// <summary>功能描述:分页查询 作　　者:AZLinli.Blog.Core</summary>
        /// <param name="whereExpression">条件表达式</param>
        ...
        public async Task<PageModel<List<TEntity>>> QueryPage(Expression<Func<TEntity, bool>> whereExpression,
        ...
        {
            return await BaseDal.GetDateTime(sql, parameters);
        }
        ...
        {
            return await BaseDal.GetDecimal(sql, parameters);
        }
        ...
        {
            return await BaseDal.GetInt(sql, parameters);
        }
        ...
        {
            return await BaseDal.GetString(sql, parameters);
        }

        /// <summary>返回实体对应数据</summary>
        ...
        {
            return await BaseDal.GetQuerylistTResult<TResult>(sql, parameters);
        }
        ...
        {
            return await BaseDal.QueryMuchtwo(
         joinExpression,
         selectExpression,
         whereLambda);
        }
        ...
        {
            return await BaseDal.Query(whereExpression, selectExpression, strOrderByFileds, top);
        }
        ...
        {
            return await BaseDal.GetQueryablePage(
         joinExpression,
           selectExpression,
        whereLambda, intPageIndex, intPageSize, strOrderByFileds);
        }
        ...
        {
            return await BaseDal.QueryPageTResult(whereExpression, selectExpression, intPageIndex, intPageSize, strOrderByFileds);
        }
    }
}