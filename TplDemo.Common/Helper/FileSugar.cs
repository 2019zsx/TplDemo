...
namespace TplDemo.Common.Helper
{
    public class FileSugar
    {
        ...
        /// <summary>根据文件目录、编号、文件名生成文件路径，并且创建文件存放目录 格式为:/directory/code/filename</summary>
        ...
        /// <summary>根据文件目录、日期、文件名生成文件路径，并且创建文件存放目录 格式为:/directory/2015/01/01/filename</summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="directory"></param>
        /// <param name="code"></param>
        /// <param name="fileName"></param>
        ...
        /// <summary>创建一个文件,并将字符串写入文件。</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        /// <summary>从文件绝对路径中获取目录路径</summary>
        /// <param name="filePath">文件的绝对路径</param>
        ...
        /// <summary>获取一个文件的长度,单位为KB</summary>
        ...
        /// <summary>获取一个文件的长度,单位为MB</summary>
        /// <param name="filePath">文件的路径</param>
        ...
        /// <summary>将文件移动到指定目录，并指定新的文件名( 剪切并改名 )</summary>
        /// <param name="sourceFilePath">需要移动的源文件的绝对路径</param>
