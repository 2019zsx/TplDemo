...
namespace TplDemo.Common.Helper
{
    public static class LogicSugarExtenions
    {
        ...
        /// <summary>根据表达式的值,true返回trueValue,false返回string.Empty;</summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="thisValue"></param>
        /// <param name="trueValue">值为true返回 trueValue</param>
        /// <returns></returns>
        ...
        /// <summary>根据表达式的值,true返回trueValue,false返回0</summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="thisValue"></param>
        /// <param name="trueValue">值为true返回 trueValue</param>
        /// <returns></returns>
        ...
        /// <summary>所有值为true，则返回true否则返回false</summary>
        /// <param name="thisValue"></param>
        ...
        /// <summary>只要有一个值为true,则返回true否则返回false</summary>
        /// <param name="thisValue"></param>
        /// <param name="andValues"></param>
        /// <returns></returns>
        ...
        /// <summary>Switch().Case().Default().Break()</summary>
        /// <typeparam name="T"></typeparam>
        /// <param name="thisValue"></param>
        /// <returns></returns>
