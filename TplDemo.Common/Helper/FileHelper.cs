...
namespace TplDemo.Common.Helper
{
    public class FileHelper : IDisposable
    {
        ...
        /// <summary>根据文件大小获取指定前缀的可用文件名</summary>
        ...
        /// <summary>指定文件夹下面的所有内容copy到目标文件夹下面</summary>
